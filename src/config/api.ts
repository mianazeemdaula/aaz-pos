...
export const API_ENDPOINTS = {
    ...
    settings: {
        ...
        backupStatus: '/settings/backup/status',
        backupJson: '/settings/backup/json',
        backupBrowse: '/settings/backup/browse',
        backupRun: '/settings/backup/run',
        backupValidateDir: '/settings/backup/validate-dir',
